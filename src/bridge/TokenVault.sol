...
import "@openzeppelin/contracts/token/ERC20Upgradeable/utils/SafeERC20Upgradeable.sol";
import "@openzeppelin/contracts/utils/Create2Upgradeable.sol";
...
/**
 * This vault holds all ERC20Upgradeable tokens (but not Ether) that users have deposited.
 * It also manages the mapping between canonical ERC20Upgradeable tokens and their bridged
 * tokens.
 *
...
contract TokenVault is EssentialContract {
    ...
    /**
     * Transfers ERC20Upgradeable tokens to this vault and sends a message to the
    ...
    /**
     * Release deposited ERC20Upgradeable back to the owner on the source TokenVault with
     * a proof that the message processing on the destination Bridge has failed.
     *
     * @param message The message that corresponds the ERC20Upgradeable deposit on the
     *                source chain.
     ...
     * @param canonicalToken The canonical ERC20Upgradeable token which may or may not
